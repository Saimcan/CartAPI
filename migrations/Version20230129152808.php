 ...
 */
final class Version20230129152808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT NOT NULL, product_id INT NOT NULL, order_placed_id INT DEFAULT NULL, quantity INT NOT NULL, unit_price NUMERIC(10, 2) NOT NULL, total NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, customer_id INT NOT NULL, items JSON NOT NULL, total NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id))');
